...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 37.69, 35.95) --
	( 56.25, 35.95) --
	( 74.82, 35.95) --
	( 93.38,184.53) --
	(111.94,184.53) --
...
\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.80] at ( 29.15, 33.19) {1.0};

\node[text=drawColor,anchor=base east,inner sep=0pt, outer sep=0pt, scale=  0.80] at ( 29.15,181.78) {1.5};
\end{scope}
\begin{scope}
\path[clip] (  0.00,  0.00) rectangle (216.81,216.81);
\definecolor[named]{drawColor}{rgb}{0.00,0.00,0.00}
...
\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.20] at (121.23,193.49) {Fitness Trap};
\end{scope}
\end{tikzpicture}
