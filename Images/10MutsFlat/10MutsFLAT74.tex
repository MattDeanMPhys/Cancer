% Created by tikzDevice version 0.7.0 on 2014-12-02 16:26:22
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 42.04, 31.57) --
	( 60.12, 32.57) --
	( 78.20, 34.13) --
	( 96.28, 37.23) --
	(114.36, 44.14) --
...
\path[fill=fillColor] ( 42.04, 31.57) circle (  2.13);

\path[fill=fillColor] ( 60.12, 32.57) circle (  2.13);

\path[fill=fillColor] ( 78.20, 34.13) circle (  2.13);

\path[fill=fillColor] ( 96.28, 37.23) circle (  2.13);

\path[fill=fillColor] (114.36, 44.14) circle (  2.13);

\path[fill=fillColor] (132.44, 50.35) circle (  2.13);

\path[fill=fillColor] (150.52, 55.90) circle (  2.13);

\path[fill=fillColor] (168.60, 56.49) circle (  2.13);

\path[fill=fillColor] (186.68, 52.86) circle (  2.13);

\path[fill=fillColor] (204.76, 79.24) circle (  2.13);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.42] at (168.60,169.70) {$t = $ 74};
