% Created by tikzDevice version 0.7.0 on 2014-12-02 16:26:39
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 42.04, 31.63) --
	( 60.12, 31.68) --
	( 78.20, 31.99) --
	( 96.28, 32.58) --
	(114.36, 34.35) --
...
\path[fill=fillColor] ( 42.04, 31.63) circle (  2.13);

\path[fill=fillColor] ( 60.12, 31.68) circle (  2.13);

\path[fill=fillColor] ( 78.20, 31.99) circle (  2.13);

\path[fill=fillColor] ( 96.28, 32.58) circle (  2.13);

\path[fill=fillColor] (114.36, 34.35) circle (  2.13);

\path[fill=fillColor] (132.44, 36.99) circle (  2.13);

\path[fill=fillColor] (150.52, 40.87) circle (  2.13);

\path[fill=fillColor] (168.60, 45.67) circle (  2.13);

\path[fill=fillColor] (186.68, 51.26) circle (  2.13);

\path[fill=fillColor] (204.76,137.44) circle (  2.13);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.42] at (168.60,169.70) {$t = $ 99};
