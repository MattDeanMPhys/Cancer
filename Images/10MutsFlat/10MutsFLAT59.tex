% Created by tikzDevice version 0.7.0 on 2014-12-04 15:29:25
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 42.04, 32.18) --
	( 60.12, 34.22) --
	( 78.20, 38.95) --
	( 96.28, 46.25) --
	(114.36, 52.69) --
...
\path[fill=fillColor] ( 42.04, 32.18) circle (  2.13);

\path[fill=fillColor] ( 60.12, 34.22) circle (  2.13);

\path[fill=fillColor] ( 78.20, 38.95) circle (  2.13);

\path[fill=fillColor] ( 96.28, 46.25) circle (  2.13);

\path[fill=fillColor] (114.36, 52.69) circle (  2.13);

\path[fill=fillColor] (132.44, 57.78) circle (  2.13);

\path[fill=fillColor] (150.52, 57.69) circle (  2.13);

\path[fill=fillColor] (168.60, 53.58) circle (  2.13);

\path[fill=fillColor] (186.68, 46.67) circle (  2.13);

\path[fill=fillColor] (204.76, 54.47) circle (  2.13);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.42] at (168.60,169.70) {$t = $ 59};
