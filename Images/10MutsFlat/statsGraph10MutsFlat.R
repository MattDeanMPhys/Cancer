...
graphDisp = graphDisp + theme(axis.ticks.length = unit(0.15, "cm"),  axis.ticks.margin = unit(0.10, "cm"))	
...
graphVel = graphVel + theme(axis.ticks.length = unit(0.15, "cm"),  axis.ticks.margin = unit(0.10, "cm"))	
...
graphVar = graphVar + theme(axis.ticks.length = unit(0.15, "cm"),  axis.ticks.margin = unit(0.10, "cm"))	
