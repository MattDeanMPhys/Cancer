% Created by tikzDevice version 0.7.0 on 2014-12-02 16:26:03
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 42.04, 32.92) --
	( 60.12, 38.04) --
	( 78.20, 46.44) --
	( 96.28, 53.44) --
	(114.36, 58.99) --
...
\path[fill=fillColor] ( 42.04, 32.92) circle (  2.13);

\path[fill=fillColor] ( 60.12, 38.04) circle (  2.13);

\path[fill=fillColor] ( 78.20, 46.44) circle (  2.13);

\path[fill=fillColor] ( 96.28, 53.44) circle (  2.13);

\path[fill=fillColor] (114.36, 58.99) circle (  2.13);

\path[fill=fillColor] (132.44, 60.33) circle (  2.13);

\path[fill=fillColor] (150.52, 54.48) circle (  2.13);

\path[fill=fillColor] (168.60, 47.20) circle (  2.13);

\path[fill=fillColor] (186.68, 40.45) circle (  2.13);

\path[fill=fillColor] (204.76, 42.20) circle (  2.13);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.42] at (168.60,169.70) {$t = $ 49};
