% Created by tikzDevice version 0.7.0 on 2014-12-02 16:37:44
...
\path[draw=drawColor,line width= 0.6pt,line join=round] ( 42.04,190.48) --
	( 60.12, 31.56) --
	( 78.20, 31.56) --
	( 96.28, 31.56) --
	(114.36, 31.56) --
...
\path[fill=fillColor] ( 42.04,190.48) circle (  2.13);

\path[fill=fillColor] ( 60.12, 31.56) circle (  2.13);

\path[fill=fillColor] ( 78.20, 31.56) circle (  2.13);

\path[fill=fillColor] ( 96.28, 31.56) circle (  2.13);

\path[fill=fillColor] (114.36, 31.56) circle (  2.13);

\path[fill=fillColor] (132.44, 31.56) circle (  2.13);

\path[fill=fillColor] (150.52, 31.56) circle (  2.13);

\path[fill=fillColor] (168.60, 31.56) circle (  2.13);

\path[fill=fillColor] (186.68, 31.56) circle (  2.13);

\path[fill=fillColor] (204.76, 31.56) circle (  2.13);

\node[text=drawColor,anchor=base,inner sep=0pt, outer sep=0pt, scale=  1.42] at (168.60,169.70) {$t = $ 0};
