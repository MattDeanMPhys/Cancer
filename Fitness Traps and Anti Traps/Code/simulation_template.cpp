...
int NUMBER_OF_CELLS = {{CELLS}};
int NUMBER_OF_MUTATIONS = {{MUTS}};
...
std::string rLandscape = "{{RLAND}}";

double rTrap = {{RTRAP}};
int rTrapStart = {{RTRAPSTART}};
int rTrapEnd = {{RTRAPEND}};

std::string uLandscape = "{{ULAND}}";

double uTrap = {{UTRAP}};
double uTrapStart = {{UTRAPSTART}};
double uTrapEnd = {{UTRAPEND}};
